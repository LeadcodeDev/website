...
export const defaultConfig: SiteConfig = {
  ...
  titleTemplate: '%s — Baptiste Parmantier',
  favicon: '/favicon.svg',
  logo: '/logo.svg',
    ...
    links: {
      documentation: [
        ...
        { label: 'footer.links.mdxComponents', href: '/{locale}/explainer/mdx-components/callout' },
        {
          ...
          href: '/{locale}/explainer/features/theme-customization',
        },
      ...
      resources: [
        {
          ...
          href: 'https://github.com/LeadcodeDev/explainer_v2',
          external: true,
        },
        { label: 'footer.links.blog', href: '', appId: 'blog' },
        {
          label: 'footer.links.changelog',
          href: 'https://github.com/LeadcodeDev/website/releases',
          external: true,
        },
      ],
      community: [
