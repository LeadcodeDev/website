---
title: "Anatomie d'un moteur réactif agnostique en Rust"
description: Premier volet d'une série où nous construisons un framework UI réactif en Rust. Nous commençons par ouvrir React et Flutter pour voir ce qu'il se passe réellement entre le moment où une variable change et celui où l'écran change.
thumbnail:
  title: "Anatomie d'un moteur réactif en Rust"
  description: Ce que font React et Flutter sous le capot, et l'architecture en trois couches que nous pouvons en tirer pour un framework Rust qui rend aussi bien dans un navigateur que dans un terminal.
  theme: default
date: 2026-09-04
