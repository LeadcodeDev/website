...
export const ui = {
  ...
  fr: {
    ...
    'expertise.iam.title': 'IAM & OIDC',
    'expertise.iam.description': "OIDC, OAuth2, FerrisKey, cycle de vie des tokens, realms multi-tenant et frontières produit sécurisées. Implémentation du protocole depuis la spec",
