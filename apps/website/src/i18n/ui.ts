...
export const ui = {
  en: {
    ...
    'projects.mineral.description': 'A framework for Discord bots designed around modular plugin architecture and a declarative API surface. Built with Dart, focused on extensibility and separation of concerns.',
  ...
  fr: {
    ...
    'projects.ferriskey.title': 'FerrisKey',
    'projects.ferriskey.description': "Plateforme IAM enterprise construite en Rust. OIDC, multi-tenancy, moteur de politiques et Kubernetes-native — conçue pour les systèmes où la correction n'est pas négociable.",
    'projects.ferriscord.title': 'Ferriscord',
    ...
    'projects.mineral.title': 'Mineral',
    'projects.mineral.description': "Un framework pour bots Discord conçu autour d'une architecture de plugins modulaire et d'une surface d'API déclarative. Construit avec Dart, axé sur l'extensibilité et la séparation des responsabilités.",
    'projects.rustmotion.title': 'Rustmotion',
